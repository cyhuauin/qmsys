...
<table id="select" >
     <tr><td>答案:<input type="text" id="answer" name="answer" required onblur="checkanswer()"/>
        ...
        <tr><td>分数:<input type="text" id="score" name="score" required onblur="checkscore()"/> <span id="divscore"></span></td></td></tr>
        <tr><td>难度:<input type="text" id="level" name="level" onblur="checklevel()"> <span id="divlevel"></span></td></td></tr>
        <tr><td>图片名称: <input type="text" id="imagename" name="imagename" onblur="checkimage()"></td></tr>
        <tr><td>章节:<input type="text" id="chapter" name="chapter" onblur="checkchapter()"> <span id="divchapter"></span></td></td></tr>
